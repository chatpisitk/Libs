...
public final class CameraConfigurationManager {
  ...
  CameraConfigurationManager(Context context) {
    ...
    setting = CameraSetting.getInstance();
  }
...
//    }	
    ...
    realResolution = new Point(width, height);
    if (width < height) {
...
//      }
    ...
    if (focusMode != null) {    
      ...
      isSupportAutoFocus = focusMode.equals(Camera.Parameters.FOCUS_MODE_AUTO);
    }else{
  ...
  void setTorch(Camera camera, boolean newSetting) {
    ...
    boolean currentSetting = setting.isEnableTorch();
    if (currentSetting != newSetting) {
      setting.enableTorch(newSetting);
    }
  }
  ...
  private Point findBestPreviewSizeValue(Camera.Parameters parameters, Point screenResolution) {
    ...
    Log.i(TAG, "Screen Mode: " + parameters.getSceneMode());
    Point bestSize = null;
